                ...
                <Container className="mt-5 mb-4 text-center text-md-left">
                    <Row className="mt-3">
                        ...
                        <Col md="2" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p><a href="#!" className="dark-grey-text">Grocery</a></p>
                            <p><a href="#!" className="dark-grey-text">Clothing</a></p>
                            <p><a href="#!" className="dark-grey-text">Cleaning Supply</a></p>
                            <p><a href="#!" className="dark-grey-text">Essentials</a></p>
                        </Col>
                        ...
                        <Col md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p><i className="fa fa-home mr-3"></i> Atlanta, GA</p>
                            <p><i className="fa fa-envelope mr-3"></i> groot@gmail.com</p>
                            <p><i className="fa fa-phone mr-3"></i> 678-707-3386</p>
                            <p><i className="fa fa-phone mr-3"></i> 678-559-6126</p>
                        </Col>
                    </Row>
                </Container>
                <div className="footer-copyright text-center py-3">
                    <Container fluid>
                        &copy; {(new Date().getFullYear())} Copyright: <a href="#"> Groot.grub </a>
                    </Container>
                </div>
            </Footer>
        );
